...
## Language Policy
- Identifiers, commit messages, and branch names: English. String literals in code (e.g. exception messages) also stay English so doctest output and logs are environment-independent.
- Docstrings, inline comments, user-facing docs (`README.md`, prose pages under `docs/source/`), PR/MR descriptions, and review comments: Japanese.
